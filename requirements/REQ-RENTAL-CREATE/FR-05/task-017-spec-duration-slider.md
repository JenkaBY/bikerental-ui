# Task 017: Spec for `DurationSliderComponent`

> **Applied Skill:** `angular-testing` — Dumb component spec. Tests that `sliderIndex` computed maps value to nearest snap point index and that `valueChange` emits the snap-point value.

## 1. Objective

Unit tests for `DurationSliderComponent`: snap-to-index mapping and `valueChange` emission.

## 2. File to Modify / Create

* **File Path:** `projects/operator/src/app/rental-create/step2/duration-slider.component.spec.ts`
...
```bash
npx ng test operator --include="**/step2/duration-slider.component.spec**"
```
