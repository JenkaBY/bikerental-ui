...
@Component({
  ...
  template: `
    <a
      ...
      class="bottom-nav-item flex flex-col items-center justify-center flex-1 py-2 no-underline text-slate-500 text-xs transition-colors [-webkit-tap-highlight-color:transparent] [touch-action:manipulation]"
    >
